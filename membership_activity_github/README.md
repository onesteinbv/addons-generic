...
2. go to System Parameters in Odoo and copy/paste the token in
   `membership_activity_github.access_token`;
3. go to Projects;
...
(Membership: Import GitHub activity)

If you imported GitHub activity but some members were not configured correctly you can
