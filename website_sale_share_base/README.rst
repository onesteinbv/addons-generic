=========================
Website Sale Share (Base)
=========================

This module is automatically installed upon installation of any website_sale_share_*
module.
It changes the social networks (Facebook, Twitter, LinkedIn, YouTube, Pinterest,
email) icons in the Product Share website snippet replacing the FontAwesome element
with an SVG image.
