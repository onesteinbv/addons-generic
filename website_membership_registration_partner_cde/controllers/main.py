...
class MembershipRegistrationControllerGithub(MembershipRegistrationController):
    def _get_partner_and_validation_data(self, post):
        ...
        partner_data["member_github_login"] = post.get("member_github_login", "")
        partner_data["member_gitlab_username"] = post.get("member_gitlab_username", "")
        partner_data["member_gitlab_email"] = post.get("member_gitlab_email", "")
