...
class MembershipGroup(models.Model):
    ...
    website_snippet_wrap_classes = fields.Char(
        string="Wrap Classes",
        default="mg_wrap mg_show_image mg_show_team",
    ...
    website_hide_member_type_ids = fields.Many2many(
        comodel_name="membership.group.member.type",
        string="Hide Member Types On Website",
    )
