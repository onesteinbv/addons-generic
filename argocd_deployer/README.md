...
Info on application sets: [user-guide/application-set](https://argo-cd.readthedocs.io/en/stable/user-guide/application-set) and
...
This is how the repo should look like: [Example application set](git@github.com:onesteinbv/odoo-generator-k8s.git)
