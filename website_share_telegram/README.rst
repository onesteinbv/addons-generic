======================
Website Share Telegram
======================

This module introduces a new share option on each Odoo website. The new option
is to share on Telegram, and it's added within the general s_share snippet
template (thus, it's automatically available on all the website sections that
call that snippet).

Because Telegram can be deployed on any domain, this module uses the two-step
