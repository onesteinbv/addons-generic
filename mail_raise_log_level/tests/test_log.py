...
class TestLog(TransactionCase):
    def test_fetch_mail(self):
        ...
        with self.assertLogs("odoo.addons.mail_raise_log_level.models.fetch_mail_server", level="ERROR") as log:
    ...
    def test_failing_outgoing_mail(self):
        ...
        # Check if the log message was captured
        with self.assertLogs("odoo.addons.mail_raise_log_level.models.mail_mail", level="ERROR") as log:
